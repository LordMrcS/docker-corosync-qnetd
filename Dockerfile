...
ADD "https://enterprise.proxmox.com/debian/proxmox-release-trixie.gpg" \
...
RUN apt-get update \
	...
	&& adduser --quiet --system --disabled-login --no-create-home \
	...
	&& apt-get clean \
	&& rm -rf /etc/corosync /var/lib/apt/lists/* /var/cache/apt/archives/*
